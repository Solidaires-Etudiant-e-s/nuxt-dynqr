...
echo "=== SoliQrCode Release Script ==="
echo
...
YNH_DIR="$PROJECT_DIR/../SoliQrCode_ynh"

echo "Committing changes in SoliQrCode_ynh..."
cd "$YNH_DIR"
git add manifest.toml
git commit -m "Upgrade SoliQrCode to v$NEXT_VERSION"
git push
